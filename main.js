...
document.getElementById('draw_p').innerHTML = 'Sketch To be Drawn: ' + sketch;
...
function gotResult(error, results) {
  ...
  document.getElementById('label_p').innerHTML = 'Your Sketch: ' + drawn_sketch;

  document.getElementById('confidence_p').innerHTML = 'Confidence: ' + Math.round(results[0].confidence * 100) + '%';
}
...
{
  timer_counter++;
  document.getElementById('timer_p').innerHTML = 'Timer: ' + timer_counter;
